...
The administration tool consists of a series of scripts triggered by the main one called adm. Calling this script with the name of one iMI sets off the startup of a VM in a VMware ESXi server with an image that will serve as the base for the administration process. Commonly the OS used will be some kind of Linux (Fedora 27, CentOS 7 or even Ubuntu 16.04 LTS)
