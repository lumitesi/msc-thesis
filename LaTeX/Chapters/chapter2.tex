...
An hypervisor can be classified into two different types, symbolising two different design strategies to virtualisation, as shown in Figure~\ref{fig:hypervisors}:
