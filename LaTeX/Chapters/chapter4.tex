...
In order to complement the Comand-Line interface previously presented and creating a more straightforward and more ubiquitous way of interacting with the replication platform, a Rest API has been introduced that provides the same functionalities as the CLI.
...
\begin{description}
	\item \texttt{GET /api/replicas} - Get the List of all Replicas 
	\item \texttt{GET /api/replicas/update} - Get the List of all Replicas 
	\item \texttt{GET /api/replicas/{replica}/imis} - Get the List of all Replicas 
\end{description}
